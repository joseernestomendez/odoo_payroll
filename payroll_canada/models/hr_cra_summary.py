...
class HrCraSummary(models.AbstractModel):
    ...
    def make_t619_xml(self, slip_return_xml, summary):
        ...
        if summary.contact_extension:
            contact_dict["cntc_extn_nbr"] = summary.contact_extension
    ...
    def _check_contact_phone(self):
        ...
        for summary in self:
            ...
            if len(str(area_code)) != 3:
                raise ValidationError(_("The area code must have 3 digits."))
    ...
    def onchange_contact_id(self):
        ...
        if self.contact_id:
            ...
            if contact.work_phone:
                phone = "".join(c for c in contact.work_phone if c.isdigit())
                ...
                self.contact_phone = "-".join([phone[0:3], phone[3:7]])
