...
from openerp.addons.payroll_employee_benefit.tests.test_employee_benefit import (
...
class TestEmployeeBenefit(TestEmployeeBenefitBase):
    def setUp(self):
        ...
        self.categories[0].write({"exemption_ids": [(4, self.exemption.id)]})

        self.categories[1].write({"exemption_ids": [(4, self.exemption_2.id)]})
